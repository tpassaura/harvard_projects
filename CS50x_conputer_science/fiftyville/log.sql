...
SELECT name, transcript
  FROM interviews
    WHERE year = 2021 AND month = 7 AND day = 28 AND transcript LIKE '%bakery%' ORDER BY name;
-- Witnesses: Eugene, Raymond, and Ruth.
...
-- CHECK THE ACCOUNT OF TRANSATICION MADE
SELECT account_number, amount
  FROM atm_transactions
    WHERE year = 2021 AND month = 7 AND day = 28 AND atm_location = 'Leggett Street' AND transaction_type = 'withdraw';
    
-- ACCOUNT NUMBER RELATIONS
...
-- CHECK NAMES BY DURATION OF CALLS
